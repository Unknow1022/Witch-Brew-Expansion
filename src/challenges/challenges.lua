...
local challenge_definitions = {
    ...
    -- 7. El Lienzo Vivo (The Living Canvas)
    {
        ...
        jokers = {
            { id = 'j_Witch_brew_charco_pintura_joker', eternal = true },
    ...
    -- 10. Sobresaturación Singular (Singular Saturation)
    {
        ...
        jokers = {
            { id = 'j_Witch_brew_sobresaturado_joker', eternal = true }
        },
        deck = {
            type = 'Challenge Deck'
        },
...
function Game:start_run(args)
    ...
    if not (args and args.savetable) and G.GAME then
        ...
        if ch_id == 'c_Witch_brew_geometria_sagrada' or ch_id == 'geometria_sagrada' or (G.GAME.challenge_tab and G.GAME.challenge_tab.id == 'c_Witch_brew_geometria_sagrada') then
